                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-description">
                                        ${this.selectedModel === 'gemini-2.5-flash'
                                            ...
                                            : this.selectedModel === 'gemini-2.5-pro' ? 'Gemini 2.5 Pro: More accurate and detailed responses, better for complex problems.' : 'Gemini 3 Pro Preview: More accurate and detailed responses, better for complex problems.'}
                                    </div>
                                </div>
                            </div>
                        ` : html`
